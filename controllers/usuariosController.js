...
exports.formCrearCuenta = (req, res) => {
	res.render('crear-cuenta', {
		nombrePagina: 'Cuenta de Usuario',
		tagline:
			'Crea tu cuenta de usuario de manera gratuita y publica tus datos, no tienes que pagar nada y podran ver tu CV miles de empresas',
	});
};
